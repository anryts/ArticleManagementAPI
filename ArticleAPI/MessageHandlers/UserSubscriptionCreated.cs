...
public class UserSubscriptionCreated : BackgroundService
{
    private readonly IServiceScopeFactory _serviceScopeFactory;
    private readonly BaseMessageHandler _baseMessageHandler;

    public UserSubscriptionCreated(IServiceScopeFactory serviceScopeFactory, IOptions<RabbitMQOptions> rabbitMqOptions)
    {
        _serviceScopeFactory = serviceScopeFactory;
        _baseMessageHandler = new BaseMessageHandler("subscription", RoutingKey.Update, rabbitMqOptions);
